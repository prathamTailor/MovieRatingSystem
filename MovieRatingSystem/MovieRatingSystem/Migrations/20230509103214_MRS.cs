...
namespace MovieRatingSystem.Migrations
{
    ...
    public partial class MRS : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MovieCelebrityRoles",
                columns: table => new
                {
                    movieCelebrityRoleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    movieId = table.Column<int>(type: "int", nullable: true),
                    celebrityId = table.Column<int>(type: "int", nullable: true),
                    roleId = table.Column<int>(type: "int", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCelebrityRoles", x => x.movieCelebrityRoleId);
                    table.ForeignKey(
                        name: "FK_MovieCelebrityRoles_Celebrity_celebrityId",
                        column: x => x.celebrityId,
                        principalTable: "Celebrity",
                        principalColumn: "celebrityId");
                    table.ForeignKey(
                        name: "FK_MovieCelebrityRoles_Movies_movieId",
                        column: x => x.movieId,
                        principalTable: "Movies",
                        principalColumn: "movieId");
                    table.ForeignKey(
                        name: "FK_MovieCelebrityRoles_Role_roleId",
                        column: x => x.roleId,
                        principalTable: "Role",
                        principalColumn: "roleId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieCelebrityRoles_celebrityId",
                table: "MovieCelebrityRoles",
                column: "celebrityId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieCelebrityRoles_movieId",
                table: "MovieCelebrityRoles",
                column: "movieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieCelebrityRoles_roleId",
                table: "MovieCelebrityRoles",
                column: "roleId");
